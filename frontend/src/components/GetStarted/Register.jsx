...
const Register = () => {
  ...
  const { checkAuth } = useAuth(); // Access checkAuth from AuthContext
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const successMsg = `${data.data?.user_name} successfully registered`;
